    ...
    function show(localeList, currentIndex) {
        ...
        for (var i = 0; i < localeList.length; i++) {
            languageListModel.append({
                                         "localeName": localeList[i],
                                         "displayName": Qt.locale(
                                                            localeList[i]).nativeLanguageName
                                     })
        }
    ...
    contentItem: ListView {
        ...
        model: ListModel {
            ...
            function selectItem(index) {
                VirtualKeyboardSettings.locale = languageListModel.get(
                            index).localeName
        ...
        delegate: Item {
            ...
            height: languageNameTextMetrics.height + languageListLabel.anchors.topMargin
            ...
            TextMetrics {
                ...
                elideWidth: languageListItem.width - languageListLabel.anchors.leftMargin
